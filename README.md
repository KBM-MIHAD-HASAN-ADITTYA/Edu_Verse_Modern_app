...
These are generated during use and are not required in source submission.

## What to Submit as ZIP
...
Do **not** include:
- `target/`
- IDE folders like `.idea/` or `.vscode/`
- generated runtime data files listed above
